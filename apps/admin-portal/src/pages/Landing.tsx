                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div className="bg-white rounded-2xl p-8 flex flex-col items-center text-center shadow-xl hover:-translate-y-2 transition-transform duration-300">
                                ...
                                <div className="w-full flex flex-col gap-3 mt-auto">
                                    <a
                                        href="https://github.com/furqan-debug/TrackOwl/releases/download/v1.4.2/TrackOwl_1.4.2_x64-setup.exe"
                                    ...
                                    <a
                                        href="https://github.com/furqan-debug/TrackOwl/releases/download/v1.4.2/TrackOwl_1.4.2_x64_en-US.msi"
                            ...
                            <div className="bg-white rounded-2xl p-8 flex flex-col items-center text-center shadow-xl hover:-translate-y-2 transition-transform duration-300">
                                ...
                                <div className="w-full flex flex-col gap-3 mt-auto">
                                    <a
                                        href="https://github.com/furqan-debug/TrackOwl/releases/download/v1.4.2/TrackOwl_1.4.2_aarch64.dmg"
                                    ...
                                    <a
                                        href="https://github.com/furqan-debug/TrackOwl/releases/download/v1.4.2/TrackOwl_1.4.2_x64.dmg"
