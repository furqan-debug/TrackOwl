...
import { LoadingState, DatePicker, FormSelect } from '../components/ui';
...
export function MemberFormPage() {
    ...
    const [keepIdleMode, setKeepIdleMode] = useState<
        'prompt' | 'always' | 'never'
    >('prompt');
    ...
    return (
        <div className="min-h-screen bg-main flex flex-col">
            {/* Top bar */}
            <div className="min-h-16 border-b border-border/60 bg-surface/80 backdrop-blur-sm sticky top-0 z-40 shrink-0">
                <div className="max-w-[1400px] mx-auto w-full px-4 sm:px-6 py-3">

                    <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:min-h-10">

                        {/* Back + title + member name */}
                        <div className="flex items-center gap-3 min-w-0 flex-1">

                            {/* Back button */}
                            <button
                                onClick={() => navigate('/dashboard/people')}
                                className="flex items-center gap-2 text-text-muted hover:text-text-primary transition-colors shrink-0 group"
                            >
                                <ArrowLeft className="w-4 h-4 group-hover:-translate-x-0.5 transition-transform shrink-0" />

                                <span className="hidden sm:inline text-[12px] font-bold whitespace-nowrap">
                                    Back to Members
                                </span>
                            </button>
                            ...
                            <div className="flex items-center gap-2 min-w-0 flex-1">
                                <Settings2 className="w-4 h-4 text-text-muted shrink-0" />

                                <span className="text-[13px] font-bold text-text-primary whitespace-nowrap shrink-0">
                                    Edit Member
                                </span>
                                ...
                                {fullName && (
                                    <>
                                        ...
                                        <span
                                            className="text-[12px] text-text-muted truncate min-w-0"
                                            title={fullName}
                                        >
                                            {fullName}
                                        </span>
                        ...
                        <button
                            onClick={handleSave}
                            disabled={saving || isRestrictedTarget || !fullName.trim()}
                            className={clsx(
                                "w-full lg:w-auto lg:min-w-[150px] shrink-0 flex items-center justify-center gap-2 px-5 h-10 rounded-xl text-[12px] font-bold transition-all shadow-lg text-white whitespace-nowrap",
                                (saving || isRestrictedTarget || !fullName.trim())
            ...
            <div className="flex-1 bg-main relative min-h-0 overflow-x-hidden">
                ...
                >
                    ...
                    >
                        {/* Member card */}
                        <div className="p-5 sm:p-6 bg-surface/60 backdrop-blur-md border border-border/60 rounded-3xl shadow-shell-md">
                            <div className="flex flex-col items-center text-center gap-5">
                                <div className="relative group cursor-pointer">
                                    ...
                                    <div
                                        className={clsx(
                                            'absolute -bottom-2 -right-2 px-2.5 py-0.5 rounded-lg text-[10px] font-black border tracking-[0.1em] shadow-shell-sm z-20',
                                            ROLE_COLORS[role] ||
                                            ROLE_COLORS['User']
                                        )}
                                    >
                                ...
                                <div className="min-w-0 max-w-full">
                                    <p className="text-[16px] font-black text-text-primary tracking-tight break-words">
                                        {fullName || 'Unknown'}
                                    </p>

                                    <p className="text-[12px] text-text-muted font-mono mt-1 break-all opacity-80">
                                        {email}
                                    </p>

                                    {department && (
                                        <p className="text-[10px] sm:text-[11px] text-primary font-bold mt-2 uppercase tracking-wider break-words">
                                            {department}
                                        </p>
                                    )}
                                </div>
                        ...
                        {/* Tab nav */}
                        <nav className="w-full flex flex-col gap-1.5 bg-surface/60 backdrop-blur-md border border-border/60 rounded-3xl p-3 shadow-shell-sm">
                            <p className="text-[10px] font-black text-text-muted uppercase tracking-[0.15em] px-4 py-2">
                                    ...
                                    >
                                        ...
                                        <div
                                            className={clsx(
                                                ...
                                                isActive
                                                    ? `${tab.bg} ${tab.color} shadow-primary/20`
                                                    : 'bg-surface-solid border border-border text-text-muted group-hover:border-text-muted/30'
                                            )}
                                        >
                    ...
                    <main className="flex-1 min-w-0">
                        <div className="w-full max-w-3xl min-w-0 mx-auto lg:mx-0 pb-12 lg:pb-20">
                            {/* Error banner */}
                            <AnimatePresence>
                                {error && (
                                    <motion.div
                                    ...
                                    >
                                        ...
                                        <button
                                            ...
                                            className="ml-auto text-rose-400/60 hover:text-rose-400 p-1 hover:bg-rose-500/10 rounded-md transition-colors"
                                        >
                                            <X className="w-4 h-4" />
                                        </button>
                                    </motion.div>
                            ...
                            <AnimatePresence mode="wait">
                                <motion.div
                                    ...
                                    className="bg-surface/80 backdrop-blur-sm border border-border/60 rounded-2xl sm:rounded-3xl md:rounded-[32px] p-4 sm:p-6 lg:p-10 shadow-premium relative min-w-0 overflow-visible"
                                >
                                    {/* Decorative light */}
                                        ...
                                        return (
                                            <div className="flex items-center gap-4 mb-8 relative z-10">
                                                ...
                                                <div className="min-w-0">
                                                    <h2 className="text-[18px] sm:text-[20px] font-black text-text-primary tracking-tight truncate">
                                                        {tab.label}
                                                    </h2>

                                                    <p className="text-[10px] sm:text-[11px] text-text-muted font-mono break-words">
                                                        {tab.id === 'General' &&
                                                            'Identity, role and employment details'}

                                                        {tab.id ===
                                                            'Compensation' &&
                                                            'Pay rate, bill rate and financial settings'}

                                                        {tab.id === 'Limits' &&
                                                            'Working hours, idle detection and tracking'}

                                                        {tab.id === 'Dates' &&
                                                            'Hire date, birthday and important milestones'}
                                                        ...
                                                        {tab.id ===
                                                            'Additional' &&
                                                            'Sensitive data and supplemental notes'}

                                                        {tab.id === 'Projects' &&
                                                            'Manage project associations for this member'}
                                                    </p>
                                                </div>
                                            </div>
                                        );
                                    ...
                                    <div className="relative z-10">
                                            ...
                                            <div className="space-y-6">
                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5">
                                                    ...
                                                    <FormSelect
                                                        ...
                                                        description={
                                                            role === 'Owner'
                                                                ? 'Transfer ownership from Organization Settings.'
                                                                : currentUserProfile?.id ===
                                                                    id
                                        ...
                                        {activeTab === 'Compensation' && (
                                            <div className="space-y-6">
                                                ...
                                                >
                                                    Pay rate is the cost to the
                                                    organization. Bill rate is
                                                    what is charged to the
                                                    client. Used for margin
                                        ...
                                        {activeTab === 'Limits' && (
                                            <div className="space-y-6">
                                                ...
                                                {idleEnabled && (
                                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5 animate-in slide-in-from-top-2 duration-200">
                                                        <FormField
                                            ...
                                            <div className="space-y-8">
                                                ...
                                                <div className="space-y-3">
                                                    ...
                                                    {assignedProjects.length ===
                                                        0 ? (
                                                        <div className="flex items-start sm:items-center gap-3 px-4 sm:px-5 py-4 sm:py-5 rounded-2xl border border-dashed border-border/60 text-text-muted min-w-0">
                                                            <FolderOpen className="w-4 h-4 opacity-30 shrink-0 mt-0.5 sm:mt-0" />

                                                            <span className="text-[11px] sm:text-[12px] font-bold opacity-40 break-words min-w-0">
                                                                No projects
                                                                assigned yet -
                                                                search below
                                                                to add one
                                                            ...
                                                            {assignedProjects.map(
                                                                (p) => (
                                                                    <div
                                                                        ...
                                                                        className="flex items-center gap-2 pl-3.5 pr-2 py-1.5 bg-primary/10 border border-primary/20 text-primary rounded-xl text-[12px] font-bold group max-w-full"
                                                                    >
                                                                        <FolderOpen className="w-3 h-3 shrink-0" />

                                                                        <span className="min-w-0 max-w-[calc(100vw-120px)] sm:max-w-none truncate">
                                                                            {
                                                                                p.name
                                                                            }
                                                                        </span>
                                                                        ...
                                                                        <button
                                                                            ...
                                                                            className="w-4 h-4 rounded-full hover:bg-primary/30 flex items-center justify-center transition-all shrink-0"
                                                                        >
                                                    ...
                                                    <div className="relative">
                                                        <div className="flex items-center gap-3 px-4 h-[52px] bg-surface border border-border rounded-xl focus-within:border-primary focus-within:ring-4 focus-within:ring-primary/8 transition-all">
                                                            ...
                                                            <input
                                                                ...
                                                                className="flex-1 min-w-0 bg-transparent text-[13px] font-bold text-text-primary placeholder:text-text-muted outline-none disabled:opacity-40"
                                                            />
                                                                    ...
                                                                    {unassignedProjects.map(
                                                                        (p) => (
                                                                            ...
                                                                            >
                                                                                ...
                                                                                <span className="text-[12px] font-bold text-text-primary flex-1 min-w-0 truncate">
                                                                                    {
                                                                                        p.name
                                                                                    }
                                                                                </span>
...
function FormField({
    ...
    return (
        <div className="space-y-2 group flex flex-col relative min-w-0">
            ...
            {error && (
                <p className="text-[11px] font-bold text-rose-400 ml-1">
                    {error}
                </p>
            )}
        </div>
