                                            ...
                                            {activeTab === 'General' && (
                                                <div className="space-y-6">
                                                    <div className="grid grid-cols-2 gap-5">
                                                        <FormField label="Full Name" value={fullName} onChange={(value: string) => { setFullName(value); if (value.trim()) { setFullNameError(''); } else { setFullNameError('Full Name is required.'); } }}
                                                            error={fullNameError}
...
function FormField({ label, value, onChange, type = 'text', icon, placeholder, error }: any) {
    return (
        <div className="space-y-2 group flex flex-col relative">
            ...
            {error && (
                <p className="text-[11px] font-bold text-rose-400 ml-1">{error}</p>
            )}
        </div>
    );
}
