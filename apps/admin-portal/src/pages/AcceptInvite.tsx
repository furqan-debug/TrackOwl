                                            ...
                                            <div className="space-y-3 pt-2">
                                                <div className="grid grid-cols-2 gap-3">
                                                    <Button 
                                                        ...
                                                        onClick={() => window.location.href = 'https://github.com/furqan-debug/TrackOwl/releases/download/v2.0.57/TrackOwl_2.0.57_x64-setup.exe'}
                                                    >
                                                        Windows
                                                    </Button>
                                                    <Button 
                                                        ...
                                                        onClick={() => window.location.href = 'https://github.com/furqan-debug/TrackOwl/releases/download/v2.0.57/TrackOwl_2.0.57_aarch64.dmg'}
                                                    >
                                                        macOS
                                                    </Button>
                                                </div>
                                                <p className="text-center text-[11px] font-medium text-text-muted mt-3">
                                                    Using an older Intel Mac? <a href="https://github.com/furqan-debug/TrackOwl/releases/download/v2.0.57/TrackOwl_2.0.57_x64.dmg" className="text-indigo-500 hover:text-indigo-400 hover:underline transition-colors">Download Intel version</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
