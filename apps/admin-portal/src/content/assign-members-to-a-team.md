---
title: Assign members to a team
category: Teams
description: Learn how to manage assign members to a team in TrackOwl.
---

# Assign members to a team

> [!NOTE]
> Hello and welcome! If you are a beginner, don't worry. TrackOwl is designed to be very intuitive. This step-by-step guide covers how to use the **Assign members to a team** feature in the Teams section.

## Overview
Understanding how to use the **Assign members to a team** feature is essential for maximizing operational visibility and team productivity. This tool has been engineered to provide detailed insights while remaining incredibly user-friendly.
...
2. Look for the **Teams** icon in the primary sidebar navigation.
3. Select **Assign members to a team** from the secondary menu.
...
2. Look at the left-hand menu and click on **Teams**.
