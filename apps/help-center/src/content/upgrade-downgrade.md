...
description: Learn how to manage upgrade/downgrade in TrackOwl.
---

# Upgrade/Downgrade

> [!NOTE]
> Hello and welcome! If you are a beginner, don't worry. TrackOwl is designed to be very intuitive. This step-by-step guide covers how to use the **Upgrade/Downgrade** feature in the Billing & Subscriptions section.

## Overview
Understanding how to use the **Upgrade/Downgrade** feature is essential for maximizing operational visibility and team productivity. This tool has been engineered to provide detailed insights while remaining incredibly user-friendly.
...
3. Select **Upgrade/Downgrade** from the secondary menu.
