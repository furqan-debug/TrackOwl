...
description: Learn how to manage gps tracking in TrackOwl.
---

# GPS tracking

> [!NOTE]
> Hello and welcome! If you are a beginner, don't worry. TrackOwl is designed to be very intuitive. This step-by-step guide covers how to use the **GPS tracking** feature in the Locations & Job Sites section.

## Overview
Understanding how to use the **GPS tracking** feature is essential for maximizing operational visibility and team productivity. This tool has been engineered to provide detailed insights while remaining incredibly user-friendly.
...
3. Select **GPS tracking** from the secondary menu.
