...
category: Financials
description: Learn how to manage payments report in TrackOwl.
---

# Payments report

> [!NOTE]
> Hello and welcome! If you are a beginner, don't worry. TrackOwl is designed to be very intuitive. This step-by-step guide covers how to use the **Payments report** feature in the Financials section.

## Overview
Understanding how to use the **Payments report** feature is essential for maximizing operational visibility and team productivity. This tool has been engineered to provide detailed insights while remaining incredibly user-friendly.
...
2. Look for the **Financials** icon in the primary sidebar navigation.
3. Select **Payments report** from the secondary menu.
...
2. Look at the left-hand menu and click on **Financials**.
...
**Q: Does this affect my current billing cycle?**  
