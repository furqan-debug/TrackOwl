...
title: Add a client
category: Clients
description: Learn how to manage add a client in TrackOwl.
---

# Add a client

> [!NOTE]
> Hello and welcome! If you are a beginner, don't worry. TrackOwl is designed to be very intuitive. This step-by-step guide covers how to use the **Add a client** feature in the Clients section.

## Overview
Understanding how to use the **Add a client** feature is essential for maximizing operational visibility and team productivity. This tool has been engineered to provide detailed insights while remaining incredibly user-friendly.
...
3. Select **Add a client** from the secondary menu.
