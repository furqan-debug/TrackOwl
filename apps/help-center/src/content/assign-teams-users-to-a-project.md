---
title: Assign teams/users to a project
category: Projects
description: Learn how to manage assign teams/users to a project in TrackOwl.
---

# Assign teams/users to a project

> [!NOTE]
> Hello and welcome! If you are a beginner, don't worry. TrackOwl is designed to be very intuitive. This step-by-step guide covers how to use the **Assign teams/users to a project** feature in the Projects section.

## Overview
Understanding how to use the **Assign teams/users to a project** feature is essential for maximizing operational visibility and team productivity. This tool has been engineered to provide detailed insights while remaining incredibly user-friendly.
...
2. Look for the **Projects** icon in the primary sidebar navigation.
3. Select **Assign teams/users to a project** from the secondary menu.
...
2. Look at the left-hand menu and click on **Projects**.
