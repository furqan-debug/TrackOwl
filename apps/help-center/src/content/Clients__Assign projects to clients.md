---
title: Assign projects to clients
category: Clients
description: Learn how to manage assign projects to clients in TrackOwl.
---

# Assign projects to clients

> [!NOTE]
> Hello and welcome! If you are a beginner, don't worry. TrackOwl is designed to be very intuitive. This step-by-step guide covers how to use the **Assign projects to clients** feature in the Clients section.

## Overview
Understanding how to use the **Assign projects to clients** feature is essential for maximizing operational visibility and team productivity. This tool has been engineered to provide detailed insights while remaining incredibly user-friendly.
...
2. Look for the **Clients** icon in the primary sidebar navigation.
3. Select **Assign projects to clients** from the secondary menu.
...
2. Look at the left-hand menu and click on **Clients**.
