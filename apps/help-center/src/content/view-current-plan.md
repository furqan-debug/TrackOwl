...
description: Learn how to manage view current plan in TrackOwl.
---

# View current plan

> [!NOTE]
> Hello and welcome! If you are a beginner, don't worry. TrackOwl is designed to be very intuitive. This step-by-step guide covers how to use the **View current plan** feature in the Billing & Subscriptions section.

## Overview
Understanding how to use the **View current plan** feature is essential for maximizing operational visibility and team productivity. This tool has been engineered to provide detailed insights while remaining incredibly user-friendly.
...
3. Select **View current plan** from the secondary menu.
