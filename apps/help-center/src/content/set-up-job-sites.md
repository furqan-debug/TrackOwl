...
description: Learn how to manage set up job sites in TrackOwl.
---

# Set up job sites

> [!NOTE]
> Hello and welcome! If you are a beginner, don't worry. TrackOwl is designed to be very intuitive. This step-by-step guide covers how to use the **Set up job sites** feature in the Locations & Job Sites section.

## Overview
Understanding how to use the **Set up job sites** feature is essential for maximizing operational visibility and team productivity. This tool has been engineered to provide detailed insights while remaining incredibly user-friendly.
...
3. Select **Set up job sites** from the secondary menu.
