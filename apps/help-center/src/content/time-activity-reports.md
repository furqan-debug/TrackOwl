...
category: Reports
description: Learn how to manage time & activity reports in TrackOwl.
---

# Time & Activity reports

> [!NOTE]
> Hello and welcome! If you are a beginner, don't worry. TrackOwl is designed to be very intuitive. This step-by-step guide covers how to use the **Time & Activity reports** feature in the Reports section.

## Overview
Understanding how to use the **Time & Activity reports** feature is essential for maximizing operational visibility and team productivity. This tool has been engineered to provide detailed insights while remaining incredibly user-friendly.
...
2. Look for the **Reports** icon in the primary sidebar navigation.
3. Select **Time & Activity reports** from the secondary menu.
...
2. Look at the left-hand menu and click on **Reports**.
