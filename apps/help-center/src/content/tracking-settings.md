...
category: Settings
description: Learn how to manage tracking settings in TrackOwl.
---

# Tracking settings

> [!NOTE]
> Hello and welcome! If you are a beginner, don't worry. TrackOwl is designed to be very intuitive. This step-by-step guide covers how to use the **Tracking settings** feature in the Settings section.

## Overview
Understanding how to use the **Tracking settings** feature is essential for maximizing operational visibility and team productivity. This tool has been engineered to provide detailed insights while remaining incredibly user-friendly.
...
2. Look for the **Settings** icon in the primary sidebar navigation.
3. Select **Tracking settings** from the secondary menu.
...
2. Look at the left-hand menu and click on **Settings**.
