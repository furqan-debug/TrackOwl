...
description: Learn how to manage create a schedule in TrackOwl.
---

# Create a schedule

> [!NOTE]
> Hello and welcome! If you are a beginner, don't worry. TrackOwl is designed to be very intuitive. This step-by-step guide covers how to use the **Create a schedule** feature in the Attendance & Schedules section.

## Overview
Understanding how to use the **Create a schedule** feature is essential for maximizing operational visibility and team productivity. This tool has been engineered to provide detailed insights while remaining incredibly user-friendly.
...
3. Select **Create a schedule** from the secondary menu.
