...
category: Settings
description: Learn how to manage security settings in TrackOwl.
---

# Security settings

> [!NOTE]
> Hello and welcome! If you are a beginner, don't worry. TrackOwl is designed to be very intuitive. This step-by-step guide covers how to use the **Security settings** feature in the Settings section.

## Overview
Understanding how to use the **Security settings** feature is essential for maximizing operational visibility and team productivity. This tool has been engineered to provide detailed insights while remaining incredibly user-friendly.
...
3. Select **Security settings** from the secondary menu.
