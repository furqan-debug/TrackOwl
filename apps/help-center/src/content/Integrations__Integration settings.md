...
description: Learn how to manage integration settings in TrackOwl.
---

# Integration settings

> [!NOTE]
> Hello and welcome! If you are a beginner, don't worry. TrackOwl is designed to be very intuitive. This step-by-step guide covers how to use the **Integration settings** feature in the Integrations section.

## Overview
Understanding how to use the **Integration settings** feature is essential for maximizing operational visibility and team productivity. This tool has been engineered to provide detailed insights while remaining incredibly user-friendly.
...
3. Select **Integration settings** from the secondary menu.
