...
category: Tasks
description: Learn how to manage task estimates in TrackOwl.
---

# Task estimates

> [!NOTE]
> Hello and welcome! If you are a beginner, don't worry. TrackOwl is designed to be very intuitive. This step-by-step guide covers how to use the **Task estimates** feature in the Tasks section.

## Overview
Understanding how to use the **Task estimates** feature is essential for maximizing operational visibility and team productivity. This tool has been engineered to provide detailed insights while remaining incredibly user-friendly.
...
2. Look for the **Tasks** icon in the primary sidebar navigation.
3. Select **Task estimates** from the secondary menu.
...
2. Look at the left-hand menu and click on **Tasks**.
