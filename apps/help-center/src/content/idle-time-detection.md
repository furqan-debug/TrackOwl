...
description: Learn how to manage idle time detection in TrackOwl.
---

# Idle time detection

> [!NOTE]
> New to tracking your time? It's easier than it looks! This guide will walk you through exactly how to use the **Idle time detection** feature. Time tracking is the core of TrackOwl, helping you log your work hours effortlessly so you can focus on what matters.

## Overview
Understanding how to use the **Idle time detection** feature is essential for maximizing operational visibility and team productivity. This tool has been engineered to provide detailed insights while remaining incredibly user-friendly.
...
2. Look for the **Time Tracking** icon in the primary sidebar navigation.
3. Select **Idle time detection** from the secondary menu.
...
1. **Log in** to your TrackOwl dashboard.
