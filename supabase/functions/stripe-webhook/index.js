...
serve(async (req) => {
    try {
        ...
        if (event.type === "customer.subscription.created" ||
            ...
            const isPremiumPrice = priceId === Deno.env.get("STRIPE_PRICE_PREMIUM_MONTHLY") ||
                priceId === Deno.env.get("STRIPE_PRICE_PREMIUM_YEARLY");
            const isBasicPrice = priceId === Deno.env.get("STRIPE_PRICE_BASIC_MONTHLY") ||
            ...
            const isYearly = priceId === Deno.env.get("STRIPE_PRICE_PREMIUM_YEARLY") ||
                priceId === Deno.env.get("STRIPE_PRICE_BASIC_YEARLY");
